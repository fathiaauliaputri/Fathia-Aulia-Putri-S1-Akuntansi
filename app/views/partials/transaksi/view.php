                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_buku">
                                        <th class="title"><i class="fa fa-book "></i> Id Buku: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-tgl_pinjam">
                                        <th class="title"><i class="fa fa-calendar-plus-o "></i> Tgl Pinjam: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-tgl_kembali">
                                        <th class="title"><i class="fa fa-calendar-minus-o "></i> Tgl Kembali: </th>
                                        <td class="value">
