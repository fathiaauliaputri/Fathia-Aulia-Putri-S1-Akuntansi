                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id">
                                        <th class="title"><i class="fa fa-android "></i> Id: </th>
                                    ...
                                    <tr  class="td-id_kategori">
                                        <th class="title"><i class="fa fa-align-justify "></i> Id Kategori: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-tahun">
                                        <th class="title"><i class="fa fa-calendar "></i> Tahun: </th>
                                        <td class="value">
